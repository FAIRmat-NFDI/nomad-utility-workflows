...
```python
import gravis as gv  # Optional, for visualization
...
# Optional: Visualize the input graph
if 'gv' in globals():  # Only if gravis is available
    gv.d3(
...
# Optional: Visualize the output graph
if 'gv' in globals():  # Only if gravis is available
    gv.d3(
