...
#   inputs:
#     - name: input system
#       section: '../upload/archive/mainfile/MOL0_160_MOL1_240/minimEQ1.log#
# /run/0/system/0'
...
#           section: '../upload/archive/mainfile/MOL0_160_MOL1_240/EQ3.log#/run/0/system
# /-1'
...
#           section: '../upload/archive/mainfile/MOL0_160_MOL1_240/PD1.log#/run/0/system
# /-1'
#         - name: final thermodynamic quantities of NPT production run
#           section: '../upload/archive/mainfile/MOL0_160_MOL1_240/PD1.log#/
#           run/0/calculation/-1'
# n_nodes = 5
